...
from std_srvs.srv import SetBool  # Import service type

class CallRequestPositionServiceNode(Node):
    def __init__(self):
        super().__init__('call_request_position_service_node')
        self.client = self.create_client(SetBool, 'palmbee/tree/request_position')
    ...
    def call_service(self, tag_id):
        ...
        request.data = tag_id  # Pass the tag_id as the request data
